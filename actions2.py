...
features = ["SajoAnker","MizuKukan","MizuAction","goho","AutoHunmuLog", 
            "carposition.z", "carsubposition.z","fireposition.z", 
            "firesubposition.z","MizuGoOrStop"]
def datasetting(files,cancel_list,name):
    ...
    for file in files:
        ...
        if int(file_name) in cancel_list:
            ...
            dff_list = []
            df = df[["time","SajoAnker","MizuKukan","MizuAction","goho","AutoHunmuLog","carposition.z", "carsubposition.z","fireposition.z", "firesubposition.z","MizuGoOrStop"]]
            ...
            toCsv(final_df,file_name ,position,name,sub_exist,sub_dir)

def toCsv(df,file_name,position,name,sub_exist,sub_dir):
    df.to_csv("output_exp2/" + name + str(file_name) + "-" + str(position) + "_" + str(sub_exist) + "_" + str(sub_dir) + '.csv')
...
name_dict = {"yoshiki2":[i for i in range(100)], "riku2":riku_cancel_list, "mako2":ono_cancel_list}
